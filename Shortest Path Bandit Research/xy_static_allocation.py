...
class StaticAllocation:
    ...
    def play(self):
        ...
        self.alloc,_ = self.getXYAllocationFW()
    ...
    def getXYAllocationFW(self,eta=1e-3,epochs=5000):
        '''
...
def runBenchmark():
    ...
    for i,d in enumerate(dVals):
        ...
        for rep in range(nReps):
            ...
            bandit = StaticAllocation(X,X,initAlloc,theta=theta)
            bandit.play() 
            results.append(bandit.sampleComplexity)
            print(bandit.sampleComplexity)
...
if __name__=='__main__':
    ...
    scXYStatic,probIncorrect = runBenchmark()
